...
- only the **calibration** made the method useful for **absolute chronology**
...
- ^14^C data are **gold standard** today for much of the (pre-)history: no archaeologist can work meaningfully at present without using ^14^C data
...
c14bazAAR provides a \textsuperscript{14}C dates search engine: \LARGE{\textbf{\url{www.neolithicRC.de}}}
